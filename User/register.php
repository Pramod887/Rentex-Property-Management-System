...
$query = "SELECT h_id, h_image FROM addhome ORDER BY RAND() LIMIT 1";
...
if (isset($_POST['submit'])) {
    ...
    $checkQuery = "SELECT COUNT(*) as count FROM registerp WHERE h_id = '$h_id'";
    ...
    $query = "INSERT INTO registerp(name, phone, email, address, h_id, h_image) VALUES ('$name', '$phone', '$email', '$address', '$h_id', '$h_image')";
    ...
    // After performing the registration operation and redirecting to rent.php
