...
if (isset($_POST['submit'])) {
    ...
    $CodeReset = mysqli_real_escape_string($conn, (rand()));
    if (mysqli_num_rows(mysqli_query($conn, "SELECT * FROM register WHERE email='{$email}'")) > 0) {
        $query = mysqli_query($conn, "UPDATE register SET CodeV='{$CodeReset}' WHERE email='{$email}'");
        if ($query) {
            ...
            try {
                ...
                $mail->Body    = '<p> This is the Verifecation Link<b><a href="http://localhost/Rentex-1/User/change-Password.php?Reset=' . $CodeReset . '">"http://localhost/Rentex-1/User/change-Password.php?Reset=' . $CodeReset . '"</a></b></p>';
        ...
        <div class="forms-container">
            <div class="signin-signup" style="left: 50%;z-index:99;">
                <form action="" method="POST" class="sign-in-form">
                    ...
                    <a href="index.php" class="btn"  style="padding:10px 55px;text-decoration:none;">Back</a>
