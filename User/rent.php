...
<body>
  ...
  <span>Discover the perfect blend of luxury and comfort in our beautifully designed homes</span>
  <span>Experience the ultimate in modern living and architectural excellence</span>
  <span>Find your dream home today and start creating lasting memories</span>
</marquee>

      <div class="col-md-12 col-lg-8">
        <div class="title-single-box">
       
          <h1 class="title-single"><i class="bi bi-house-door-fill"></i>Our Amazing Home's</h1>
        </div>
    ...
    <section class="property-grid grid">
      ...
      <img src="<?php echo '../seller/homeupload/' . $row->h_image; ?>" alt="" class="img-a img-fluid" style="cursor: pointer;" />
                  </div>
                  <div class="card-overlay">
                    <div class="card-overlay-a-content">
                      <div class="card-header-a">
                        <h2 class="card-title-a">
                          <a href="property-single.php?h_id=<?php echo $row->h_id; ?>"><?php echo $row->h_name; ?></a>
                        </h2>
                      </div>
                      <div class="card-body-a">
                        ...
                        <a href="property-single.php?h_id=<?php echo $row->h_id; ?>" class="link-a">Click here to view
                          <span class="bi bi-chevron-right"></span>
                        </a>
                      </div>
                      <div class="card-footer-a">
                      <a href="cart.php?h_id=<?php echo $row->h_id; ?>" class="btn btn-primary" onclick="showAlert()">Favourite</a>
                        <a href="register.php?h_id=<?php echo $row->h_id; ?>" class="btn btn-primary">Register</a>
                      </div>
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  marquee.addEventListener('mouseleave', function() {
    marquee.classList.remove('hovered');
  });
});
</script>
<script>
function showAlert() {
  alert("Property added  Favourites Successfully!");
}
</script>
