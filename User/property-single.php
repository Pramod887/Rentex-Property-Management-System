...
if (isset($_GET['p_id'])) {
  ...
  $query = "SELECT * FROM addpg WHERE p_id = $propertyId";
  ...
  <!-- End Header/Navbar -->
    ...
    <body>
      <div class="property-details animated fadeInUp">
        <img src="<?php echo '../seller/homeupload/'.$property->p_image; ?>" alt="Property Image" class="property-image">
        <table class="property-table">
          ...
          <tr>
            <th>Price</th>
            <td><?php echo $property->p_phone; ?></td>
          </tr>
          <tr>
            <th>Category</th>
          ...
          <tr>
            <th>Details</th>
            <td><?php echo $property->p_details; ?></td>
          </tr>
        </table>
        <a href="pg.php" class="rent-button">Back</a>
...
// Check if the property ID is provided in the query parameter
if (isset($_GET['h_id'])) {
  $propertyId = $_GET['h_id'];

  // Fetch the property details from the addhome table based on the ID
  $query = "SELECT * FROM addhome WHERE h_id = $propertyId";
  $result = $conn->query($query);
...
<body>
  ...
  <!-- End Header/Navbar -->
    ...
    <body>
      <div class="property-details animated fadeInUp">
        <img src="<?php echo '../seller/homeupload/'.$property->h_image; ?>" alt="Property Image" class="property-image">
        <table class="property-table">
          <tr>
            <th>Property Title</th>
            <td><?php echo $property->h_name; ?></td>
          </tr>
          <tr>
            <th>Price</th>
            <td><?php echo $property->h_phone; ?></td>
          </tr>
          <th>City</th>
            <td><?php echo $property->h_add; ?></td>
          </tr>
          <tr>
            <th>Category</th>
            <td><?php echo $property->cat; ?></td>
          ...
          <tr>
            <th>Details</th>
            <td><?php echo $property->h_details; ?></td>
          </tr>
        </table>
        <a href="rent.php" class="rent-button">Back</a>
        <!-- Display other property details as needed -->
      </div>
      <?php include 'footer.php';?>
