  ...
  <span>Find your dream home today and start creating lasting memories</span>
          ...
          <div class="col-md-12 col-lg-8">
            <div class="title-single-box">
              <h1 class="title-single"><i class="bi bi-house-door-fill"></i>Our Amazing Flats</h1>
            </div>
          </div>
                    ...
                    <div class="card-overlay-a-content">
                      <div class="card-header-a">
                        <h2 class="card-title-a">
                          <a href="property-singlel1.php?f_id=<?php echo $row->f_id; ?>"><?php echo $row->f_name; ?></a>
                        </h2>
                      </div>
                      <div class="card-body-a">
                        ...
                        <a href="property-singel1.php?f_id=<?php echo $row->f_id; ?>" class="link-a">Click here to view
                          <span class="bi bi-chevron-right"></span>
                        </a>
                      </div>
                      <div class="card-footer-a">
                      <a href="cart2.php?f_id=<?php echo $row->f_id; ?>" class="btn btn-primary" onclick="showAlert()">Favourite</a>
                        <a href="register2.php?f_id=<?php echo $row->f_id; ?>" class="btn btn-primary">Register</a>
                      </div>
