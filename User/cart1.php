...
if (isset($_GET['p_id'])) {
    ...
    if (!$itemExists) {
        ...
        $propertyDetails = getPropertyDetails($p_id);
        ...
        header("Location: cart1.php?error=" . urlencode($errorMsg));
        exit();
    }
...
<?php if (count($cartItems) > 0): ?>
    ...
    <table>
        ...
        <?php foreach ($cartItems as $index => $item): ?>
            <tr>
                <td><img src="../seller/homeupload/<?php echo $item->p_image; ?>" alt="Property Image"></td>
                <td><?php echo $item->p_name; ?></td>
                <td><?php echo $item->p_phone; ?></td>
                <td><a href="cart1.php?delete=<?php echo $index; ?>" class="delete-button">Delete</a></td>
                <td><a href="property-singel2.php?p_id=<?php echo $item->p_id; ?>" class="delete-button">View</a></td>
            </tr>
        <?php endforeach; ?>
    </table>
<?php else: ?>
...
<!-- Back button -->
<a href="pg.php" class="back-button">Back</a>
