            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">registered pg </h4>
                    </div>
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        <div class="d-md-flex">
                            <ol class="breadcrumb ms-auto">
                                <li><a href="#" class="fw-normal">paying guest</a></li>
                            </ol>
                        </div>
                    </div>
                </div>
                                ...
                                <table class="table no-wrap"  style="background-color: white">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="txt-oflo"><a href="deleteregistration1.php?p_id=<?php echo $row->p_id; ?>">Delete</a></td>
